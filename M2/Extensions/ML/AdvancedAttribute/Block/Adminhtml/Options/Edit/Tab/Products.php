...
use ML\AdvancedAttribute\Model\Option;
...
class Products extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    {
        /* @var $model \ML\AdvancedAttribute\Model\Slide */
        $this->addColumn(
            'in_product',
            [
    ...
    protected function getBannerOption()
    {
        ...
        $bannerOption   = $this->_objectManager->create('ML\AdvancedAttribute\Model\Option');
        if ($bannerOptionId) {
