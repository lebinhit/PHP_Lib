...
namespace ML\AdvancedAttribute\Block\Adminhtml\Options;
...
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{
    ...
    /**
     * @var \ML\AdvancedAttribute\Model\ResourceModel\Option\CollectionFactory
     */
    ...
    public function __construct(
        ...
        \ML\AdvancedAttribute\Model\ResourceModel\Option\CollectionFactory $bannerCollectionFactory,
        array $data = []
    ) {
    ...
    protected function _prepareCollection()
    {
        ...
        /** @var \ML\AdvancedAttribute\Model\ResourceModel\Option\Collection $collection */
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn(
            ...
            [
                ...
                'class' => 'xxx',
                'width' => '50px',
                'renderer' => 'ML\AdvancedAttribute\Block\Adminhtml\Options\Renderer\Label',
            ]
        );
        ...
        $this->addColumn(
            ...
            [
                'header' => __('Banner'),
                'index' => 'image',
                'renderer' => 'ML\AdvancedAttribute\Block\Adminhtml\Options\Renderer\Image',
            ]
        );
        $this->addColumn(
            'edit_attribute',
            [
                'header' => __('Action'),
                'renderer' => 'ML\AdvancedAttribute\Block\Adminhtml\Options\Renderer\EditUrl',
            ]
        );
